-- ============================================================================
-- RUN THIS WHOLE FILE IN THE SUPABASE SQL EDITOR (one go).
-- It creates the site-settings tables AND makes Ashraful a platform admin.
-- Same content as migrations/0006_site_settings.sql, plus the admin row.
-- ============================================================================
...
-- ---------------------------------------------------------------------------
-- Platform admin: asrafulislam2000@gmail.com
-- Looked up by email, so it keeps working even if the user id ever changes.
-- ---------------------------------------------------------------------------
insert into public.platform_admins (user_id)
select id from auth.users where email = 'asrafulislam2000@gmail.com'
